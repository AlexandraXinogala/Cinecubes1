...
/*	public CubeQuery createCubeQueryStartOfActSlide( String num_act, String measure ) {
		CubeQuery cubequery = new CubeQuery("Act " + String.valueOf(num_act));
		cubequery.setAggregateFunction( "Act " + String.valueOf(num_act));
		cubequery.addMeasure(1,measure,null)
		cubequery.setBasicStoredCube(null);
		return cubequery;
	}
	
	
	public void createSqlQueryStartOfActSlide(CubeQuery cubequery, String num_act, String measure ) {
